...
public class Ejercicio10 {
	...
	private void initialize() {
		...
		ItemListener itemL = new ItemListener() {
			// MANERA MAS EFICIENTE, DE ABEL (SIN ATRIBUTO COLOR)
			@Override
			public void itemStateChanged(ItemEvent e) {
				radioRojo.setSelected(combo1.getSelectedItem().equals(ROJO));
				radioVerde.setSelected(combo1.getSelectedItem().equals(VERDE));
				radioAzul.setSelected(combo1.getSelectedItem().equals(AZUL));
			}
		};
		combo1.addItemListener(itemL);
		...
		FocusListener focusListener = new FocusListener() {
			...
			public void focusGained(FocusEvent e2) {
				...
				if (combo1.getSelectedItem().equals(ROJO)) {
					tfColorFocus.setBackground(Color.RED);
				...
				if (combo1.getSelectedItem().equals(AZUL)) {
					tfColorFocus.setBackground(Color.BLUE);
				}
			}
		};
